...
/**
 * Variant of {@link SequentialSpinClock} for tests that does not prevent JUnit's timeout from working.
 */
public final class SequentialSpinTestClock extends AbstractSynchronizedClock {
    /**
